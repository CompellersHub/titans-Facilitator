...
import type { Course, CourseCategory, CourseModule, CreateCourseData } from "@/lib/types"
...
export function useCreateCourse() {
  ...
  return useMutation({
    mutationFn: async (courseData: CreateCourseData) => {
      ...
      formData.append("target_audience", JSON.stringify(courseData.target_audience))
      formData.append("learning_outcomes", JSON.stringify(courseData.learning_outcomes))
      formData.append("required_materials", JSON.stringify(courseData.required_materials))
...
export function useUpdateCourse() {
  ...
  return useMutation({
    mutationFn: ({ courseId, data }: { courseId: string; data: Partial<CreateCourseData> }) =>
